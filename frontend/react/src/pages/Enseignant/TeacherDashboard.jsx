...
export default function Dashboard() {
  ...
  const fetchRequests = async () => {
    ...
    try {
      const res = await fetch("http://localhost:5000/api/teacher/teacher-requests", {
        headers: {
    ...
    <div className="dashboard">
      <div className="dashboard-header">
        ...
        <div className="header-actions">
          <button className="new-request-button" onClick={() => navigate("/CreatePrintRequest")}>
                ...
                <tr key={request._id}>
                  ...
                  <td>
                    <button
                      ...
                      onClick={
                        () => {navigate(`/PrintRequest/${request._id}`)}}
